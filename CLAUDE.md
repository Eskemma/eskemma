...
/
├── app/
│   ├── api/                          # 142 API route handlers (recontado 26-09-26: 142, sin cambio (4a solo editó rutas existentes); 26-09-24 +`geo/candidatos`, −`geo/resolver-municipio`)
