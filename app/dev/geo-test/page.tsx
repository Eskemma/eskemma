...
export default function GeoTestPage() {
  ...
  return (
    <div className="min-h-screen bg-white-eske dark:bg-[#0D2035] p-6">
      ...
      <p className="text-sm text-black-eske-20 dark:text-white/50 mb-5 max-w-2xl">
      ...
      {lastScope && (
        <div className="mt-4 rounded bg-blue-eske/5 border border-blue-eske/15 px-4 py-2.5 text-xs font-mono text-black-eske-20 dark:text-white/55">
